  ...
  return (
    <>
        ...
        <FadeIn className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)]">
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="space-y-4 text-sm text-white/80">
              ...
              <p>
                The throughline is empathy with structure: how we can design, speak, and decide in
                ways that remain human without losing institutional clarity.
              </p>
              <Divider />
      ...
      <Section className="pt-0" containerClassName="max-w-5xl">
        <FadeIn className="surface grid gap-8 p-8 md:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] md:p-10">
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/70">
              Primary channel: <TextLink href={`mailto:${siteConfig.email}`}>{siteConfig.email}</TextLink>
            </p>
          </div>
          ...
          <div className="space-y-4 rounded-3xl border border-white/10 bg-black/30 p-6 text-sm text-white/75">
            ...
            <p>
              <TextLink href={siteConfig.linkedin}>LinkedIn</TextLink>
            </p>
          </div>
        </FadeIn>
      </Section>
